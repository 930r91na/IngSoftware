import unittest
from biggestNumber import biggestNumber
...
class TestMain(unittest.TestCase):
    ...
    def test_biggest_at_beginning(self):
        numbers = [5, 4, 3, 2, 1]
        self.assertEqual(biggestNumber(numbers), 5)
    ...
    def test_negative_numbers(self):
        numbers = [-1, -2, -3, -4, -5]
        self.assertEqual(biggestNumber(numbers), -1)
    
    # Test mixed numbers
    def test_mixed_numbers(self):
        numbers = [-1, 2, -3, 4, -5]
        self.assertEqual(biggestNumber(numbers), 4)
    ...
    def test_big_array(self):
        ...
        self.assertEqual(biggestNumber(numbers), 999999)
